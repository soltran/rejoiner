...
@rem ##########################################################################
@rem
@rem  streaming-graphql-client startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and STREAMING_GRAPHQL_CLIENT_OPTS to pass JVM options to this script.
...
@rem Execute streaming-graphql-client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %STREAMING_GRAPHQL_CLIENT_OPTS%  -classpath "%CLASSPATH%" com.google.api.graphql.examples.streaming.graphqlclient.GraphQlGrpcClient %CMD_LINE_ARGS%
...
:fail
rem Set variable STREAMING_GRAPHQL_CLIENT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%STREAMING_GRAPHQL_CLIENT_EXIT_CONSOLE%" exit 1
exit /b 1
